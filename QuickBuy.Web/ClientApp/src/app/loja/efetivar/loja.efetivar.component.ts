...
import { LojaCarrinhoCompras } from "../carrinho-compras/loja.carrinho.compra";
...
export class LojaEfetivarComponent implements OnInit {
  ...
  public atualizarPreco(produto: Produto, quantidade: number) {
    ...
    this.carrinhoCompra.atualizar(this.produtos);
    this.atualizarTotal();
  ...
  public criarPedido(): Pedido {
    ...
    pedido.enderecoCompleto = 'Francisco Ortiz Amigo';
